...
*/
    ...
    reg [0:0]                     ip2cpu_data_r, ip2cpu_data_r_next;
    ...
    reg   [0:0]               c_data_in_bram;
    wire  [0:0]               c_data_out_bram;
    ...
    reg       [0:0]                            ip2cpu_@PREFIX_NAME@_reg_data_adj;
    ...
    wire     [0:0]                             cpu2ip_@PREFIX_NAME@_reg_data_adj;
    ...
    generate
    if (C_S_AXI_DATA_WIDTH > 1) begin: SMALL_REG
